...
class Mosquito:
    def __init__(self):
        ...
        # sprite: create the rect and load the images of the mosquito (randomly) 
        self.rect = pygame.Rect(start_pos[0], start_pos[1], size[0]//1.4, size[1]//1.4)
        # thêm vài hình ảnh muỗi vào list images
        self.images = [image.load(f"Assets/mosquito/{random.randint(1,3)}.png", size=size, flip=moving_direction=="right")]

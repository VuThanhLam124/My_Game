...
MOSQUITOS_SIZES = (50, 50)
MOSQUITO_SIZE_RANDOMIZE = (2,3) # for each new mosquito, it will multiply the size with an random value beteewn X and Y
BEE_SIZES = (45, 45)
BEE_SIZE_RANDOMIZE = (2, 3)

# drawing
DRAW_HITBOX = False # will draw all the hitbox

# animation
ANIMATION_SPEED = 0.275 # the frame of the insects will change every X sec

# difficulty
GAME_DURATION = 22.5 # the game will last X sec
MOSQUITOS_SPAWN_TIME = 0.75
MOSQUITOS_MOVE_SPEED = {"min": 5, "max": 8}
